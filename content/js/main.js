    ...
    var e, a = function(t, s) {
        ...
        if (y.params = s, y.originalParams = h, y.classNames = [], void 0 !== e && "undefined" != typeof Dom7 && (e = Dom7), (void 0 !== e || (e = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (y.$ = e, y.currentBreakpoint = void 0, y.getActiveBreakpoint = function() {
            ...
            y.onTouchStart = function(a) {
                ...
                var t, s, r, i;
                return void 0 === a && (a = "x"), y.params.virtualTranslate ? y.rtl ? -y.translate : y.translate : (r = window.getComputedStyle(e, null), window.WebKitCSSMatrix ? (s = r.transform || r.webkitTransform, s.split(",").length > 6 && (s = s.split(", ").map(function(e) {
                    return e.replace(",", ".")
                        ...
                        for (var a = 0; a < y.slides.length; a++) {
                            ...
                            if (y.isHorizontal() ? y.rtl && (n = -n) : (p = l, l = 0, o = -n, n = 0), t[0].style.zIndex = -Math.abs(Math.round(s)) + y.slides.length, y.params.flip.slideShadows) {
                                var d = y.isHorizontal() ? t.find(".swiper-slide-shadow-left") : t.find(".swiper-slide-shadow-top"),
                                    m = y.isHorizontal() ? t.find(".swiper-slide-shadow-right") : t.find(".swiper-slide-shadow-bottom");
                                0 === d.length && (d = e('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "left" : "top") + '"></div>'), t.append(d)), 0 === m.length && (m = e('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "right" : "bottom") + '"></div>'), t.append(m)), d.length && (d[0].style.opacity = Math.max(-s, 0)), m.length && (m[0].style.opacity = Math.max(s, 0))
                            }
                ...
                setDragPosition: function(e) {
                    ...
                    s < r ? s = r : s > i && (s = i), s = -s / a.moveDivider, y.updateProgress(s), y.setWrapperTranslate(s, !0)
                },
                ...
                scrollToSlide: function(e, a, t) {
                    if (a)
                        for (var s = 0, r = y.slides.length; s < r; s++) {
                            ...
                            if (n === a && !i.hasClass(y.params.slideDuplicateClass)) {
                                var o = i.index();
                                y.slideTo(o, e, t)
                            }
    ...
    t(i).ready(function() {
        function o() {
            this.elements = {
                ...
                masthead: t(".masthead"),
                forms: t("form")
            }, this.sectionIdPrefix = "#/", this.config = this.getConfig(), this.forms = {
                currentForm: null,
                submitting: !1,
                errors: []
            }, t(s).on("load", this.checkHash.bind(this)), t(i).on("keyup", this.onKeyUp.bind(this)), this.elements.header.on("click", ".header-logo-link", this.onLogoLinkClick.bind(this)), this.elements.header.on("click", ".menu-toggle", this.onMenuToggleClick.bind(this)), this.elements.header.on("click", ".menu-link", this.onMenuLinkClick.bind(this)), this.elements.masthead.on("click", ".masthead-cta-button", this.onMastheadCtaButtonClick.bind(this)), t("a[data-form]").on("click", this.onFormButtonClick.bind(this)), this.elements.popups.on("click", ".popup .popup-close, .popups-background", this.onPopupCloseClick.bind(this)), this.elements.forms.on("submit", this.onFormSubmit.bind(this)), this.elements.forms.on("reset", this.onFormReset.bind(this)), this.initRecaptcha(), this.initPlupload(), this.initCtaSwipers(), this.initClientSwipers(), this.initSharing(), this.initArchivePage()
        }
        o.prototype.getConfig = function() {
            var e = {};
            return "undefined" != typeof GoSeeConfig && (e = GoSeeConfig), e
        }, o.prototype.initRecaptcha = function() {
            var e = i.createElement("script");
            s.onRecaptchaLoaded = this.onRecaptchaLoaded.bind(this), e.src = "https://www.google.com/recaptcha/api.js?onload=onRecaptchaLoaded&render=explicit&hl=en", t("head").append(e)
        }, o.prototype.onRecaptchaLoaded = function() {
            var e = this.elements.body.find("#footer form .g-recaptcha");
            e.size() && this.renderRecaptchaWidget(e)
        }, o.prototype.renderRecaptchaWidget = function(e) {
            if (e.size()) {
                var t = grecaptcha.render(e.attr("id"), {
                    sitekey: GoSeeForms.recaptcha.site_key
                });
                e.data("widget-id", t).addClass("rendered")
            }
        }, o.prototype.getRecaptchaResponse = function(e) {
            if (e.size()) {
                var t = e.data("widget-id");
                return grecaptcha.getResponse(t)
            }
            return null
        }, o.prototype.resetRecaptchaWidget = function(e) {
            if (e.size()) {
                var t = e.data("widget-id");
                grecaptcha.reset(t)
            }
        }, o.prototype.onLogoLinkClick = function(e) {
            this.elements.body.hasClass("home") && (e.preventDefault(), this.scrollTo(this.elements.masthead, 500), this.setHash(""), this.isMenuOpen() && this.closeMenu())
        }, o.prototype.isMenuOpen = function() {
            return !(!this.elements.header.hasClass("menu-open") || !this.elements.header.find(".menu-container").is(":visible"))
        }, o.prototype.onMenuToggleClick = function(e) {
            e.preventDefault(), this.isMenuOpen() ? this.closeMenu() : this.openMenu()
        }, o.prototype.closeMenu = function() {
            this.elements.header.find(".menu-container").hide(), this.elements.header.removeClass("menu-open")
        }, o.prototype.openMenu = function() {
            this.elements.header.find(".menu-container").show(), this.elements.header.addClass("menu-open")
        }, o.prototype.onMenuLinkClick = function(e) {
            if (this.elements.body.hasClass("home")) {
                var i = t(e.currentTarget);
                if ("scroll" === i.data("type")) {
                    e.preventDefault();
                    var s = i.attr("href"),
                        o = this.getTargetSectionElmFromHref(s);
                    o && (this.closeMenu(), this.scrollTo(o, 500), this.setHash(s))
                }
            }
        }, o.prototype.getTargetSectionElmFromHref = function(e) {
            return t('.section[id="' + e.replace(this.sectionIdPrefix, "").replace(this.config.site_url, "") + '"]')
        }, o.prototype.getTargetArticleElmFromHref = function(e) {
            return t('.article[id="' + e.replace(this.sectionIdPrefix, "").replace(this.config.site_url, "") + '"]')
        }, o.prototype.onMastheadCtaButtonClick = function(e) {
            var i = t(e.currentTarget);
            if ("scroll" === i.data("type")) {
                e.preventDefault();
                var s = i.attr("href"),
                    o = this.getTargetSectionElmFromHref(s);
                o && (this.scrollTo(o, 500), this.setHash(s))
            }
        }, o.prototype.onFormButtonClick = function(e) {
            e.preventDefault();
            var i = t(e.currentTarget),
                s = i.data("form");
            s && (this.isPopupOpen() ? this.closePopup(function() {
                this.openPopup(s)
            }.bind(this)) : this.openPopup(s))
        }, o.prototype.isPopupOpen = function() {
            return !(!this.elements.popups.is(":visible") || !this.elements.popups.hasClass("open"))
        }, o.prototype.closePopup = function(e) {
            this.elements.popups.find(".popup:visible").hide(), this.elements.popups.removeClass("open"), this.elements.body.removeClass("popup-open"), e && e()
        }, o.prototype.openPopup = function(e, t) {
            var i = this.elements.popups.find('.popup form[data-form="' + e + '"]'),
                s = i.closest(".popup");
            if (this.isMenuOpen() && this.closeMenu(), s) {
                this.elements.body.addClass("popup-open"), this.elements.popups.addClass("open"), s.show();
                var o = s.find(".g-recaptcha");
                o.hasClass("rendered") || this.renderRecaptchaWidget(o)
            }
            t && t()
        }, o.prototype.onPopupCloseClick = function(e) {
            e.preventDefault(), this.closePopup()
        }, o.prototype.onKeyUp = function(e) {
            27 === e.keyCode && this.isPopupOpen() ? this.closePopup() : 27 === e.keyCode && this.isMenuOpen() && this.closeMenu()
        }, o.prototype.getHash = function(e) {
            return -1 !== e.indexOf(this.sectionIdPrefix) ? e.substr(e.indexOf(this.sectionIdPrefix) + this.sectionIdPrefix.length) : null
        }, o.prototype.setHash = function(e) {
            s.location.hash = "" === e ? "" : "/" + this.getHash(e)
        }, o.prototype.checkHash = function() {
            var e = this.getHash(s.location.href);
            if (e) {
                var t = this.getTargetSectionElmFromHref(e);
                this.elements.body.hasClass("blog") && (t = this.getTargetArticleElmFromHref(e)), t.size() ? this.scrollTo(t, 500) : this.setHash("")
            }
        }, o.prototype.initPlupload = function() {
            "undefined" != typeof plupload && t(".field.file").each(function(e, i) {
                var s = t(i),
                    o = s.closest(".file-field"),
                    n = new plupload.Uploader({
                        runtimes: "html5,flash,silverlight,html4",
                        container: o.get(0),
                        browse_button: s.attr("id"),
                        drop_element: s.attr("id"),
                        url: GoSeeForms.upload_url,
                        multipart_params: {},
                        multi_selection: !1,
                        multiple_queues: !1,
                        max_file_count: 1,
                        filters: {
                            ...
                            mime_types: [{
                                ...
                                extensions: GoSeeForms.allowed_mime_types
                            }]
                        },
                        flash_swf_url: GoSeeForms.plupload.flash,
                        silverlight_xap_url: GoSeeForms.plupload.silverlight,
                        init: {
                            FilesAdded: function(e, t) {
                                t.length && (o.find(".file-name").text(t[0].name), o.addClass("has-file"), e.start())
                            },
                            FileUploaded: function(e, t, i) {
                                var s = JSON.parse(i.response);
                                !0 === s.success && s.hasOwnProperty("file") && s.file.hasOwnProperty("url") ? o.find(".file-input").val(s.file.url) : (o.removeClass("has-file").find(".file-name").text(""), o.find(".file-input").val(""), e.removeFile(t), "disallowed_mime_type" === s.error && s.hasOwnProperty("message") && alert(s.message))
                            },
                            Error: function(e, t) {
                                t.hasOwnProperty("code") && -601 === t.code ? alert(GoSeeForms.mime_error_message) : t.hasOwnProperty("message") && alert(t.message)
                            }
                        }
                    });
                o.data("uploader", n), n.hasOwnProperty("init") && n.init()
            })
        }, o.prototype.initCtaSwipers = function() {
            var e = {
            ...
            t(".cta-swiper").each(function(i, s) {
                var o = t(s),
                    n = new Swiper(o, e);
                o.data("swiper", n)
            })
        }, o.prototype.initClientSwipers = function() {
            var e = {
                slidesPerView: 4,
                spaceBetween: 20,
                nextButton: ".swiper-button.next",
            ...
            t(".clients-swiper").each(function(i, s) {
                var o = t(s),
                    n = new Swiper(o, e);
                o.data("swiper", n)
            })
            ...
            e.preventDefault();
            var i = t(e.currentTarget);
            if (!this.forms.submitting) {
                this.forms.submitting = !0, this.forms.currentForm = i;
                i.find(".field").each(this.validateFormField.bind(this)).bind(this), this.isValidForm(i) ? this.submitForm(i, function() {}) : this.forms.submitting = !1
            }
        }, o.prototype.submitForm = function(e, i) {
            t.ajax(this.config.ajax_url, {
                type: "post",
                data: e.serialize(),
                dataType: "json",
                error: function(e, t, i) {},
                success: function(s, o, n) {
                    if ("success" === o && !0 === s.success)
                        if (e.hasClass("archive-form")) {
                            var r = t(".section.articles"),
                                a = r.find(".articles-list");
                            if (s.hasOwnProperty("markup")) {
                                var p = t(s.markup);
                                a.empty().append(p)
                            }
                            r.find(".search-result-header").show(), r.find(".load-more").hide(), e.trigger("reset"), i && i()
                        } else {
                            if (s.hasOwnProperty("message")) {
                                var l = t("<div>");
                                return l.addClass("form-message").html(t(s.message)), e.find(".form-fields, .form-actions").hide(), e.siblings(".form-title").hide(), e.append(l), void(e.closest(".form-popup") ? setTimeout(function() {
                                    this.closePopup(function() {
                                        l.remove(), e.find(".form-fields, .form-actions").show(), e.siblings(".form-title").show(), e.trigger("reset"), i && i()
                                    })
                    ...
                    else this.forms.submitting = !1
                }.bind(this)
            })
        }, o.prototype.validateFormField = function(e, i) {
            var s = t(i);
            if (!s.hasClass("required")) return !0;
            "email" === s.attr("type") ? this.isValidEmail(s.val()) ? this.setFieldError(s, !1) : this.setFieldError(s, !0) : s.val().length > 2 ? this.setFieldError(s, !1) : this.setFieldError(s, !0)
        }, o.prototype.setFieldError = function(e, t) {
            t ? e.addClass("error") : e.removeClass("error")
        }, o.prototype.isValidForm = function(e) {
            return !(e.find(".field.error").size() || !this.getRecaptchaResponse(e.find(".g-recaptcha")) && (alert("Check the reCAPTCHA checkbox"), 1))
        }, o.prototype.onFormReset = function(e) {
            var i = t(e.currentTarget);
            this.forms.currentForm = null, this.forms.submitting = !1, this.forms.errors = [], i.find(".field").each(function(e, i) {
                this.setFieldError(t(i), !1)
            }.bind(this));
            var s = i.find(".field.file");
            if (s.size()) {
                var o = s.closest(".file-field");
                o.removeClass("has-file"), o.find(".file-input").val(""), o.find(".file-name").text("");
                var n = o.data("uploader");
                n && (n.splice(), n.refresh())
            }
            this.resetRecaptchaWidget(i.find(".g-recaptcha"))
        }, o.prototype.wait = function(e, t) {
            return s.setTimeout(t, 1e3 * e)
        }, o.prototype.getWindowWidth = function() {
            return parseInt(t(s).width())
        }, o.prototype.scrollTo = function(e, i, s) {
            var o = parseInt(this.elements.header.outerHeight(!0)) + parseInt(this.elements.header.css("top"));
            if (e.hasClass("section") && e.hasClass("content-section")) {
                var n = e.find(".content-image"),
                    r = this.getWindowWidth();
                if ("static" !== n.css("position") && (r > 1530 || r < 1044)) {
                    o += -1 * (parseInt(n.css("top")) || 0)
                }
            } else e.hasClass("section") && e.prev(".section").hasClass("divider-section") && (e = e.prev(".section.divider-section"));
            t("html, body").animate({
                scrollTop: e.offset().top - o
            }, i, "swing", function() {
                s && s()
            })
        }, o.prototype.isValidEmail = function(e) {
            return /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(e)
        }, o.prototype.initSharing = function() {
            var e = t(".articles-list");
            e.on("click", ".sharing-item.url .sharing-button", this.shareURL.bind(this)), e.on("click", ".sharing-item.facebook", this.shareFacebook.bind(this)), e.on("click", ".sharing-item.linkedin", this.shareLinkedin.bind(this)), e.on("click", ".sharing-item.twitter", this.shareTwitter.bind(this))
        }, o.prototype.shareURL = function(e) {
            e.preventDefault(), t(e.currentTarget).parents(".sharing").toggleClass("show")
        }, o.prototype.shareFacebook = function(e) {
            e.preventDefault(), FB.ui({
                method: "share",
                href: t(e.currentTarget).find(".sharing-button").attr("data-href")
            })
        }, o.prototype.shareLinkedin = function(e) {
            e.preventDefault();
            var i = t.param({
                url: t(e.currentTarget).find(".sharing-button").attr("data-href"),
                mini: !0
            });
            this.openSharePopup("https://www.linkedin.com/shareArticle?" + i, "Share to LinkedIn", 800, 600)
        }, o.prototype.shareTwitter = function(e) {
            e.preventDefault();
            var i = t.param({
                url: t(e.currentTarget).find(".sharing-button").attr("data-href"),
                text: "",
            ...
            this.openSharePopup("http://twitter.com/share?" + i, "Share to Twitter", 600, 350)
        }, o.prototype.openSharePopup = function(e, t, i, o, n, r) {
            r = r || screen.width / 2 - i / 2, n = n || screen.height / 2 - o / 2, s.open(e, t, "resizable=1,width=" + i + ",height=" + o + ",top=" + n + ",left=" + r)
        }, o.prototype.initArchivePage = function() {
            this.$articlesList = t(".articles-list"), this.$loadMoreButton = t(".load-more", ".articles"), this.$loadMoreButton.on("click", this.loadMoreArticlesHandler.bind(this))
        }, o.prototype.loadMoreArticlesHandler = function(e) {
            e.preventDefault();
            var i = this;
            this.loadedArticleIds = [], t("article", this.$articlesList).each(function(e, s) {
                i.loadedArticleIds.push(parseInt(t(s).attr("data-article-id")))
            }), t.ajax(this.config.ajax_url, {
                type: "get",
                data: {
                    action: "load_more_articles",
                    ids: this.loadedArticleIds
                },
                dataType: "json",
                error: function(e, t, i) {},
                success: function(e, t, s) {
                    if (e && e.status) {
                        if (e.posts.length > 0)
                            for (var o = 0; o < e.posts.length; o++) {
                                var n = e.posts[o];
                                i.$articlesList.append(n)
                            }
                        e.show_button ? i.$loadMoreButton.show() : i.$loadMoreButton.hide()
                    }
                }
            })
        }, e.Main = new o
    })
}(window.GoSee = window.GoSee || {}, jQuery, document, window);